...
import { format, isToday, isWithinInterval, isYesterday, parseISO, startOfWeek, subDays } from "date-fns";
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
      ...
      <View className="bg-white px-5 py-4 border-b border-gray-100">
        ...
        <Text className="text-sm text-gray-500 mt-1">Your recent progress and achievements</Text>
      </View>
                    ...
                    return (
                      <View
                        ...
                        className={`flex-row items-center p-4 ${
                          index < group.data.length - 1 ? "border-b border-gray-100" : ""
                        }`}
                      >
                        <View
